...
//实例化默认模型
use app\common\model\ProductTiku as M;

class ProductTiku extends Base
{
    protected $validate = 'ProductTiku';
    ...
    public function index(){
        ...
        //调取列表
        $list = Db::name('product_tiku')
            ->order('sort asc,id asc')
            ->where($where)
            ->select();
            
        foreach ($list as $key => $val){
            $list[$key]['num'] = Db::name('spec')->where('tiku_id',$val['id'])->count();
        }
    ...
    public function addPost(){
        ...
        $validate = new \app\common\validate\ProductTiku;
